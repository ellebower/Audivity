...
### `npm run deploy`
Deploys the build folder to the Firebase server.<br>
Open [https://audivity-dev.firebaseapp.com/](https://audivity-dev.firebaseapp.com/) to view it in the browser.<br>
Only deploy after you run "npm run build".
...
# Audivity
Audivity-Website
>>>>>>> 74480f9ddfe0a07af10dd5f2e1b9b8b4f6818ae6
